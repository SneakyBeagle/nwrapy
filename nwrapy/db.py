...
class DB:
    ...
    def __init_name(self, name: str) -> str:
        """
    ...
    def insert(self, table_name: str, column_names: list, values: list):
        assert len(column_names) == len(
            values
        ), "Different number of column names and values"
    ...
    def select(self, table_name: str, column_names: list, where: str = None) -> sqlite3.Cursor:
